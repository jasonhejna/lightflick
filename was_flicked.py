...
class DetermineSwitch:
    ...
    def check_for_flick(self):
        ...
        if len(self.running_flick_counts) > 3:
            ...
            if self.running_flick_counts[2] > 3 and self.running_flick_counts[0] == self.running_flick_counts[1] and self.running_flick_counts[0] == self.running_flick_counts[2]:
